...
import com.snackhole.simpledimensionalores.SimpleDimensionalOresMain;
...
public class ClientProxy implements IProxy {
    ...
    public void registerItemRenderer(Item item, int meta, String id) {
        ModelLoader.setCustomModelResourceLocation(item, meta, new ModelResourceLocation(SimpleDimensionalOresMain.MODID + ":" + id, "inventory"));
    }
}
